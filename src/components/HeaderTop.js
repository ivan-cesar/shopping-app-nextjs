            ...
            <div className="container py-4">
                <div className="flex justify-between items-center">
                    <div className="hidden lg:flex gap-1">
                        ...
                        <div className="header_top__icon_wrapper"><BsTwitterX /></div>
                    ...
                    <div className="flex gap-4">
                        <select name="currency" id="currency" className="text-gray-500 text-[12px] w-[70px] bg-white"> 
                            <option>USD $</option>
                            <option>EURO €</option>
                            <option>INR ₹</option>
                        </select>
                        <select name="language" id="language" className="text-gray-500 text-[12px] w-[80px] bg-white">
